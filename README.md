...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,js,ts,next,react,redux,nodejs,express,golang,mongodb,mysql,npm,postman,c,cpp,git,github,aws,netlify,vercel,docker,figma,vscode,&perline=7)](https://skillicons.dev)
